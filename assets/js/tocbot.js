    ...
    var e = {
                    ...
                    function i(n, o) {
                        var l,
                            ...
                            d = o.appendChild(
                                ...
                                e.listItemClass &&
                                    c.setAttribute("class", e.listItemClass),
                                e.onClick && (a.onclick = e.onClick),
                                e.includeTitleTags &&
                                    a.setAttribute("title", l.textContent),
                                e.includeHtml && l.childNodes.length
                                    ? t.call(l.childNodes, function (e) {
                        ...
                        updateToc: function (i) {
                            ...
                            if (
                                ...
                                n.call(u, function (t, n) {
                                    return c(t) > s + e.headingsOffset + 10
                                        ? ((d = u[0 === n ? n : n - 1]), !0)
                                        : n === u.length - 1
                                        ? ((d = u[u.length - 1]), !0)
                                        : void 0;
                                ...
                                h &&
                                    ...
                                    (h.className += r + e.activeLinkClass);
                                var p = h.parentNode;
                                p &&
                                    -1 ===
                                        p.className.indexOf(
                                            e.activeListItemClass
                                        ) &&
                                    (p.className += r + e.activeListItemClass);
                                var C = document
                                    .querySelector(e.tocSelector)
                                    .querySelectorAll(
                                        "." +
                                ...
                                t.call(C, function (t) {
                                    ...
                                    h.nextSibling &&
                                        -1 !==
                                            h.nextSibling.className.indexOf(
                                                e.isCollapsedClass
                                            ) &&
                                        (h.nextSibling.className =
                                            h.nextSibling.className
                                                .split(r + e.isCollapsedClass)
                                                .join("")),
            ...
            971: function (e, t, n) {
                ...
                (l = []),
                                ...
                                (s.init = function (e) {
                                    if (
                                        ...
                                        i.skipRendering ||
                                            ...
                                            (this._scrollListener = m(function (
                                                e
                                            ) {
                                                t.updateToc(l),
                                                    !i.disableTocScrollSync &&
                                                        d(i);
                                                var n =
                                                    e &&
                                                    e.target &&
                                        ...
                                        var p = null;
                                        return (
                                            (this._clickListener = m(function (
                                                e
                                            ) {
                                                i.scrollSmooth &&
                    ...
                    void 0 ===
                        (r = "function" == typeof o ? o.apply(t, l) : o) ||
                        (e.exports = r);
            },
            279: (e) => {
                e.exports = function (e) {
                    ...
                    function l(t) {
                        ...
                        return (
                            ...
                            e.headingObjectCallback
                                ? e.headingObjectCallback(l, t)
                                : l
                        );
                    }
                    return {
                    ...
                    document.body.addEventListener(
                        ...
                        function (r) {
                            ...
                            "a" !== (i = r.target).tagName.toLowerCase() ||
                                ...
                                r.target.className.indexOf("no-smooth-scroll") >
                                    -1 ||
                                ("#" ===
                                    r.target.href.charAt(
                                        r.target.href.length - 2
                                    ) &&
                                    "!" ===
                                        r.target.href.charAt(
                                ...
                                -1 ===
                                    r.target.className.indexOf(e.linkClass) ||
                                (function (e, t) {
                                    var n,
                                        o,
